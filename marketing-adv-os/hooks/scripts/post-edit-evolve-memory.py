...
<COWORK>/marketing/.memory-evolver-pending.json. A SKILL `memory-evolver` e a que
...
def main() -> int:
    ...
    state_file = cowork / "marketing" / "cowork-state.json"
    ...
    pending_path = cowork / "marketing" / ".memory-evolver-pending.json"
